...
pub use palette::{
    BG_ACTIVE, BG_ELEVATED, BG_HIGHLIGHT, BG_PANEL, BG_SURFACE, BG_VOID, BORDER, BORDER_DIM,
    BORDER_FOCUS, BORDER_SUBTLE, TEXT_DIM, TEXT_DISABLED, TEXT_MUTED, TEXT_PRIMARY, TEXT_SECONDARY,
};
